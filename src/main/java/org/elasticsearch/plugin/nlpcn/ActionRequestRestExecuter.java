...
public class ActionRequestRestExecuter {
    ...
    public ActionRequestRestExecuter(SqlElasticRequestBuilder requestBuilder, RestChannel channel, final RestHighLevelClient client) {
    ...
    public void execute() throws Exception {
        ...
        if (requestBuilder instanceof JoinRequestBuilder) {
            ...
            client.searchAsync((SearchRequest) request, RequestOptions.DEFAULT, new RestStatusToXContentListener<SearchResponse>(channel));
